...
class gameActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        questions = Constains.getQuestions().toMutableList()
        questions.shuffle()
        ...
        binding.apply {
            ...
            when (selectedOptionId) {
                1 -> btnOptionOne.backgroundTintList =
                    ColorStateList.valueOf(ContextCompat.getColor(this@gameActivity, R.color.selected_color))
    ...
    private fun checkAnswer() {
        binding.apply {
            ...
            when (currentQuestion.correctAnswerId + 1) {
                1 -> btnOptionOne.backgroundTintList =
                    ColorStateList.valueOf(ContextCompat.getColor(this@gameActivity, R.color.correct_color))
                2 -> btnOptionTwo.backgroundTintList =
                    ColorStateList.valueOf(ContextCompat.getColor(this@gameActivity, R.color.correct_color))
                3 -> btnOptionThree.backgroundTintList =
                    ColorStateList.valueOf(ContextCompat.getColor(this@gameActivity, R.color.correct_color))
